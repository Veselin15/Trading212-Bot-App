    ...
    <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-10">
        ...
        <div>
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <h1 className="text-2xl font-semibold tracking-tight text-slate-50">
              Welcome back, <span className="text-violet-400">{userEmail ?? "you@example.com"}</span>
            </h1>
            {planTier === "pro" ? (
              <Badge className="border-violet-500/45 bg-violet-500/15 text-violet-200">Pro</Badge>
            ) : (
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card variant="accent" className="relative overflow-hidden p-6">
          ...
          <div className="pointer-events-none absolute -left-28 -bottom-24 h-72 w-72 rounded-full bg-indigo-500/10 blur-3xl" />
          ...
          <div className="relative">
            ...
            <div className="mt-6">
              {proFeatures ? (
                <ButtonLink href="/download" className="h-11 w-full gap-2 bg-violet-500 text-slate-950 hover:bg-indigo-500">
