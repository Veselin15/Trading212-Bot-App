...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Focus on European stocks with tax-efficient withholding considerations built into the strategy.",
    tone: "sky" as const,
    tag: "Strategy",
  },
  {
    ...
    desc: "Momentum, value, and quality signals combined into a robust long-only model backtested over 36 months.",
    tone: "emerald" as const,
    tag: "Alpha",
  },
  {
