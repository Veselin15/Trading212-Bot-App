...
export function HeroFirstSection() {
  ...
  return (
    <div className="grid items-start gap-12 lg:grid-cols-12 lg:gap-x-10 lg:gap-y-0">
      ...
      >
        <div className="inline-flex cursor-default items-center gap-2 rounded-full border border-slate-800/70 bg-white/5 px-3 py-1 text-xs text-slate-300 shadow-sm backdrop-blur transition-all duration-300 hover:border-sky-500/30 hover:bg-white/[0.08]">
