...
export function BacktestSummary() {
  ...
  return (
    <div ref={rootRef} className="mt-4 flex flex-col gap-3 sm:mt-5">
      <div className="rounded-2xl border border-white/10 bg-zinc-900 px-4 py-3 transition-[border-color,box-shadow] duration-200 hover:border-violet-500/25 hover:shadow-[0_0_24px_-10px_rgba(139,92,246,0.22)]">
